...
if __name__ == "__main__":
    ...
    FILE="./c4_generated_suffix_t5_small_multi_news.txt"
    ...
    for i in range(10000):
        ...
        for elastic_result in elastic_results:
            ...
            if len(sgsplag_obj.detections) == 0:
                ...
                random_or_translate+=1    
            serialize_features(elastic_result["id"], i, sgsplag_obj.detections, outdir, type_plag, summary_flag, gpt_txt, elastic_result['text'])
